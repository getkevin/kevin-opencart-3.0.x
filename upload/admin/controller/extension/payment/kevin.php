...
class ControllerExtensionPaymentKevin extends Controller {
	...
	public function getProjectSettings() {
		...
		$clientId = $this->config->get('payment_kevin_client_id') ? $this->config->get('payment_kevin_client_id') : '';
		$clientSecret = $this->config->get('payment_kevin_client_secret') ? $this->config->get('payment_kevin_client_secret') : '';
	...
	public function index() {
		...
		$image_width = $this->config->get('payment_kevin_image_width') ? $this->config->get('payment_kevin_image_width') : 64;
		$image_height = $this->config->get('payment_kevin_image_height') ? $this->config->get('payment_kevin_image_height') : 64;
